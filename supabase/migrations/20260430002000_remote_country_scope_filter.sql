-- Respect services.remote_scope when delivery_mode = remote.
-- country-bounded remote rows now require the search location country to match
-- professional_search_profiles.country_code.
